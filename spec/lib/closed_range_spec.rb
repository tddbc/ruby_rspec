  ...
  describe "#includes?" do
    where(:case_name, :lower_endpoint, :upper_endpoint, :target_integer, :expected) do
      [
        ...
        ["含む場合-上端点と同値", 3, 7, 7, true],
        ["含む場合-負の整数の閉区間", -7, -3, -7, true],
        ["含む場合-混合の整数の閉区間", -3, 7, -3, true],
        ["含む場合-下端点・上端点・指定整数が全て同値", 3, 3, 3, true],
        ["含まない場合-下端点より1だけ低い値", 3, 7, 2, false],
        ["含まない場合-上端点より1だけ高い値", 3, 7, 8, false],
      ]
    end
    ...
    with_them do
      ...
      it "指定した整数が閉区間内に含むかどうかを判定できる" do
